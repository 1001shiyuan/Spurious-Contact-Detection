...
def perform_leiden_clustering(filtered_contact_matrix, random_seed):
    mask = filtered_contact_matrix.row != filtered_contact_matrix.col  # Exclude self-loops before clustering
    filtered_contact_matrix = coo_matrix((filtered_contact_matrix.data[mask], 
                                          (filtered_contact_matrix.row[mask], filtered_contact_matrix.col[mask])),
                                         shape=filtered_contact_matrix.shape)
